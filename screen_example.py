...
class RunText(SampleBase):
    ...
    def run(self):
        ...
        font_large.LoadFont("/home/aryeh/rpi-rgb-led-matrix/fonts/6x9.bdf")
        font_small = graphics.Font()
        font_small.LoadFont("/home/aryeh/rpi-rgb-led-matrix/fonts/4x6.bdf")
        ...
        while True:
            ...
            graphics.DrawText(offscreen_canvas, font_small, 0, 10, textColor, "Train times:")
